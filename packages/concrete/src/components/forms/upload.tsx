...
import { Dropzone, Field, UploadItem, type UploadItemProps } from '../../primitives'
...
export function FileUpload({
	...
	return (
		<Field
			...
			success={success}
		>
			<div className={classes.fileUpload} {...props}>
				<Dropzone
					active={dragActive}
				...
				>
					<input
						...
						type="file"
					/>
					<label className={classes.fileUploadAction} htmlFor={inputId}>
						Choose files
					</label>
				</Dropzone>
...
export function ImageUpload({ className, variant = 'single', ...props }: ImageUploadProps) {
	return (
		<div className={cn(classes.imageUpload, className)} data-variant={variant}>
			<FileUpload
				accept="image/*"
