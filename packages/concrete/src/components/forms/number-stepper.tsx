...
import { clampOptionalNumber, type FieldChromeProps, getNumber, getOptionalNumber } from './shared'
...
export function NumberStepper({
	...
	return (
		<Field
			...
			success={success}
		>
			<div className={classes.numberStepper} data-disabled={disabled ? true : undefined}>
				<button
