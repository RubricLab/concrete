...
export type ToolbarControlProps = HTMLAttributes<HTMLDivElement> & {
	compact?: boolean
	label?: string
}
...
export type ToolbarControlGroupProps = HTMLAttributes<HTMLDivElement>

export function ToolbarControlGroup({ children, className, ...props }: ToolbarControlGroupProps) {
	return (
...
export type ToolbarControlSeparatorProps = HTMLAttributes<HTMLSpanElement>

export function ToolbarControlSeparator({ className, ...props }: ToolbarControlSeparatorProps) {
	return (
		<span aria-hidden className={cn(concreteClassNames.toolbarRootSeparator, className)} {...props} />
	)
}

export type ToolbarControlButtonAppearance = 'chip' | 'icon' | 'subtle'

export type ToolbarControlButtonProps = Omit<
	ButtonHTMLAttributes<HTMLButtonElement>,
	'children'
> & {
	appearance?: ToolbarControlButtonAppearance
	children?: ReactNode
...
export type ToolbarFormatGlyphFormat = 'bold' | 'italic' | 'strikethrough' | 'underline'

export type ToolbarFormatGlyphProps = HTMLAttributes<HTMLSpanElement> & {
	format: ToolbarFormatGlyphFormat
}

export function ToolbarFormatGlyph({
	children,
	className,
	format,
	...props
	...
	return (
		<span className={cn(getToolbarFormatGlyphClassName(format), className)} {...props}>
			{children}
		</span>
	)
}

function getToolbarFormatGlyphClassName(format: ToolbarFormatGlyphFormat): string | undefined {
	switch (format) {
		case 'bold':
			return undefined
		case 'italic':
			return concreteClassNames.toolItalic
		case 'strikethrough':
			return concreteClassNames.toolStrike
		case 'underline':
			return concreteClassNames.toolUnderline
	}
}
