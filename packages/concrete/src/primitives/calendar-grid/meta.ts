...
export const calendarGridMeta = {
	category: 'form',
	description: 'Calendar picker panel with month navigation, weekdays, range, and disabled states.',
	guidance:
		'CalendarGrid owns date grid chrome and keyboard/selectable day affordances. DatePicker and DateRangePicker own value state and range commit behavior.',
	name: 'Calendar panel',
	pressure: ['product'],
	props: [
...
} as const satisfies CalendarGridMeta
