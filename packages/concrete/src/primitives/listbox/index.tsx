...
export type { ListboxInput, ListboxSize, ListboxValue } from './schema'
export { listboxPropsSchema, listboxSchema, listboxSizeSchema } from './schema'
...
function renderListboxInput({ empty, emptyLabel, optionCount, size }: ListboxValue) {
	...
	return (
		<Listbox emptyLabel={emptyLabel} size={size}>
			{empty
				? null
