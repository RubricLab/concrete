...
const conceptFrameSizeValues = ['small', 'medium', 'large'] as const

export type ConceptFrameSize = (typeof conceptFrameSizeValues)[number]
...
export const conceptFramePrimitivePropsSchema = z
	.object({
		kind: z.enum(conceptFrameKindValues).default('browser-window'),
		muted: z.boolean().default(false),
		selected: z.boolean().default(false),
		size: z.enum(conceptFrameSizeValues).default('medium')
	})
	.strict()

export const conceptFramePrimitiveDefinition = defineConcretePrimitive({
	category: 'diagram',
	component: ConceptFrame,
	controls: [
		selectControl('kind', 'Kind', 'browser-window', conceptFrameKindValues),
		selectControl('size', 'Size', 'medium', conceptFrameSizeValues),
	...
	renderExample: renderConceptFrameExample,
	schema: conceptFramePrimitivePropsSchema,
	slug: 'concept-frame',
	states: states([
